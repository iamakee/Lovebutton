...
export default function Home() {
  return <main className="paper-grain overflow-hidden">
    <section className="relative flex min-h-[100svh] items-center justify-center px-5 sm:px-6">
      ...
      <Reveal className="relative z-10 max-w-2xl text-center"><Lily className="mx-auto mb-8" size={124}/><p className="mb-6 text-[10px] uppercase tracking-[.3em] text-[#9e846f]">A little date, from Vellore to Mumbai</p><h1 className="serif text-6xl leading-none sm:text-8xl">Hi Aru <span className="text-[#c98e84]">♥</span></h1><p className="mx-auto mt-9 max-w-md whitespace-pre-line text-[15px] leading-8 text-[#657067]">I know you haven&apos;t been having the easiest of days lately.{`\n\n`}I wish I were there to hug you.{`\n\n`}Since I can&apos;t...{`\n\n`}I thought I&apos;d bring a few memories to you instead.</p><Link href="/date" className="mt-10 inline-flex min-h-11 items-center gap-2 rounded-full border border-[#cbb29a] bg-white/60 px-7 py-3 text-sm text-[#556154] shadow-sm"><span>Let&apos;s go on another date</span><Lily size={20}/></Link></Reveal>
    </section>
    <div id="memories">
